...
<!--sidebar-menu-->
<?php $page='account'; include 'includes/sidebar.php'?>
<!--sidebar-menu-->

<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="payment.php" class="current">Accounts</a> </div>
    <h1 class="text-center">Activate User Account <i class="fas fa-group"></i></h1>
  </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered data-table table-hover'>
            ...
            <tbody> 
                ...
                <td><div class='text-center'><?php echo $row['status']?></div></td>
                <td><div class='text-center'><a href='user-active.php?id=<?php echo $row['user_id']?>'><button class='btn btn-success btn'><i class='fas fa-file'></i> Active</button></a></div></td>
                <td><div class='text-center'><a href='user-active.php?id=<?php echo $row['user_id']?>'><button class='btn btn-danger btn'><i class='fas fa-file'></i> Deactivate</button></a></div></td>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Membership Management System</a> </div>
</div>
