...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">List <i class="fas fa-calendar"></i></h1>
  </div>
           ...
           <tbody> 
            ...
            <?php
              ...
              ?>
                ...
                <div class='text-center'><a href='actions/delete-attendance.php?id=<?php echo $row['user_id'];?>'><button class='btn btn-danger'>ACTIVE<i class='fas fa-clock'></i></button> </a></div>
                </td>
            ...
            <?php } else {
                ...
                <td><div class='text-center'><a href='actions/check-attendance.php?id=<?php echo $row['user_id'];?>'><button class='btn btn-info'>NOT ACTIVE <i class='fas fa-map-marker-alt'></i></button> </a></div></td>
