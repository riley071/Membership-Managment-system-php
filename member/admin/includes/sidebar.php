<div id="sidebar"><a href="#" class="visible-phone"><i class="fas fa-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="<?php if($page=='attendance'){ echo 'submenu active'; } else { echo 'submenu';}?>"> <a href="#"><i class="fas fa-calendar-alt"></i> <span>Actively</span></a>
      <ul>
        <li class="<?php if($page=='attendance'){ echo 'active'; }?>"><a href="attendance.php"><i class="fas fa-arrow-right"></i> Active Yes/No</a></li>
    ...
    <li class="<?php if($page=='account'){ echo 'active'; }?>"><a href="account.php"><i class="fas fa-hand-holding"></i> <span>Active Accounts</span></a></li>
