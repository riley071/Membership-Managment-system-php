          ...
          <div class="row-fluid">
            ...
            <div class="span4">
              <ul class="site-stats">
                ...
                <li class="bg_ls"><i class="fas fa-book"></i> <strong><?php include 'actions/count-equipments.php';?></strong> <small>Available </small></li>
                ...
                <li class="bg_lr"><i class="fas fa-user-ninja"></i> <strong><?php include 'actions/count-trainers.php';?></strong> <small>Active Congoma local observers</small></li>
      ...
      <div class="span6">
        <div class="widget-box">
          <div class="widget-title bg_ly" data-toggle="collapse" href="#collapseG2"><span class="icon"><i class="fas fa-chevron-down"></i></span>
            <h5>Registered Congoma Members: Overview</h5>
          </div>
    ...
    <div class="row-fluid">
      ...
      <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="fas fa-tasks"></i></span>
            <h5>Organization Activities Lists</h5>
          </div>
          <div class="widget-content">
            <div class="todo">
              <ul>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; 2023</a> </div>
</div>
