        ...
        <div class="widget-content nopadding">
          <form action="add-member-req.php" method="POST" class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="fullname" placeholder="Organization name" />
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text"  class="span11" name="gender" placeholder="Add business email"  />
               </div>
            </div>
            <!-- <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <label>
                  ...
                  General Membership Certificate <small>- $55 per month</small></label>
                <label>
                  <input type="radio" value="Sauna" name="services" />
                  Lifetime Membership Certificate <small>- $35 per month</small></label>
                <label>
                  <input type="radio" value="Cardio" name="services" />
                  Honorary Membership Certificate <small>- $40 per month</small></label>
              </div>
            </div>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Membership Management</a> </div>
</div>
