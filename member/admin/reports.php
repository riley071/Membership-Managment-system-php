...
<html lang="en">
<head>
<title>Membership Management System Admin</title>
<meta charset="UTF-8" />
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>  
           ...
           {  
                ...
                var options = {  
                      title: 'Percentage of Congoma Members',  
                      //is3D:true,  
                      pieHole: 0.0 
                     };  
...
<div id="content">
  ...
  <div id="content-header">
    <h1 class="text-center">Certificate Report <i class="fas fa-chart-bar"></i></h1>
  </div>
  <div class="container-fluid">
