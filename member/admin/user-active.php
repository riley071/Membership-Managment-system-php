...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="payment.php">Active Account</a> <a href="#" class="current">User</a> </div>
    <h1>User Account</h1>
  </div>
          ...
          <div class="widget-content">
            <div class="row-fluid">
              <div class="span5">
                <!-- <table class="">
                  <tbody>
                  <tr>
                      <td><img src="../img/icontest3.png" alt="Gym Logo" width="175"></td>
                    </tr>
                    <tr>
                      <td><h4>MemberShip Management System</h4></td>
                    </tr>
                    <tr>
            ...
            <div class="row-fluid">
             ...
             <input type="hidden" name="id" value="<?php echo $row['user_id'];?>">
                  ...
                  <button class="btn btn-warning btn-large" type="SUBMIT" href="">Active Account</button> 
				</div>
