...
<head>
        <title>Membership System </title><meta charset="UTF-8" />
    ...
    <div id="loginbox">            
            ...
            <form id="recoverform" action="../customer/pages/register-cust.php" method="POST" class="form-vertical">
				<p class="normal_text">Enter your details below and we will send your details for further activation process.</p>
                    ...
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lo"><i class="icon-pencil"></i></span><input type="text" name="fullname" placeholder="Organization name" />
                        </div>
                    </div>
                    ...
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lo"><i class="icon-file"></i></span><input type="text" name="gender" placeholder="organization email" />
                        </div>
                    </div>
                ...
                <br>
                    ...
                    <div class="controls">
                        ...
                        <div class="controls">
                            ...
                            <option selected="true" disabled="disabled">Select certificate type</option>
                                <option value="charity" >Charitable Orientation </option>
