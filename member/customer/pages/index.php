...
<!--Header-part-->
<div id="header">
  <h1><a href="index.php">Membership management System</a></h1>
</div>
<!--close-Header-part--> 
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; 2023 nacit</a> </div>
</div>
