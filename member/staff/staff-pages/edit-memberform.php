...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Membership</a></h1>
</div>
<!--close-Header-part--> 
        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <label>
                  <input type="radio" value="general" name="services" />
                  General</label>
                <label>
                  <input type="radio" value="hon" name="services" />
                  Hon</label>
                <label>
                  <input type="radio" value="lifetime" name="services" />
                  Lifetime</label>
              </div>
            </div>
