...
<html lang="en">
<head>
<title>Membership System Staff A/C</title>
<meta charset="UTF-8" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="dashboard.html">Membership Management</a></h1>
</div>
<!--close-Header-part--> 
      ...
      <div class="center">
        <ul class="stat-boxes2">
          ...
          <li>
            ...
            <div class="right"> <strong><?php include 'actions/count-equipments.php' ?></strong> Activites </div>
          </li>
          <li>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Developed </a> </div>
</div>
